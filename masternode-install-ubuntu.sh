# !/bin/bash
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='emoji.conf'
CONFIGFOLDER='/root/.emoji'
COIN_DAEMON='emojid'
COIN_CLI='emoji-cli'
COIN_TX='emoji-tx'
COIN_PATH='/usr/local/bin/'
OS_VERSION=$(lsb_release -d)
COIN_TGZP='https://github.com/emojiproject/wallets/releases/download/v1001/emoji-linux.zip'
COIN_BOOTSTRAP='https://github.com/emojiproject/wallets/releases/download/v1001/bootstrap.zip'
COIN_BOOTSTRAP_NAME=$(echo $COIN_BOOTSTRAP | awk -F'/' '{print $NF}')
COIN_TGZ=$(echo $COIN_TGZP | awk -F'/' '{print $NF}')
COIN_NAME='emoji'
COIN_NAME_OLD='emojid'
PROJECT_NAME='EMOJI (emoj)'
COIN_EXPLORER='http://explorer.emojiproject.net/'
COIN_PORT=15452
RPC_PORT=15453
...
cat << EOF > /root/emoji-general-info
echo -e "\n\n${BLUE}=======================================================================================================${NC}\n"
echo -e "${GREEN}$PROJECT_NAME General Info: ${NC}"
$COIN_CLI getinfo
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/emoji-general-info

cat << EOF > /root/emoji-fee-info
echo -e "\n\n${BLUE}=======================================================================================================${NC}\n"
echo -e "${GREEN}$PROJECT_NAME Fee Info: ${NC}"
$COIN_CLI getfeeinfo 100
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/emoji-fee-info

cat << EOF > /root/emoji-networkinfo
echo -e "\n\n${BLUE}=======================================================================================================${NC}\n"
echo -e "${GREEN}$PROJECT_NAME Network Info: ${NC}"
$COIN_CLI getnetworkinfo
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/emoji-networkinfo

cat << EOF > /root/emoji-masternode-stats
echo -e "\n\n${BLUE}=======================================================================================================${NC}\n"
...
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/emoji-masternode-stats
...
echo -e "alias emojiinfo='/root/emoji-general-info'" >> /root/.bashrc
echo -e "alias feestats='/root/emoji-fee-info'" >> /root/.bashrc
echo -e "alias networkstats='/root/emoji-networkinfo'" >> /root/.bashrc
echo -e "alias mnstats='/root/emoji-masternode-stats'" >> /root/.bashrc
exec bash
}
...
function important_information() {
 ...
 echo -e "You can also use ${RED}emoji-cli getinfo${NC}, ${RED}emoji-cli getnetworkinfo${NC}, ${RED}emoji-cli getconnectioncount${NC}commands for a nice looking infos.${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
